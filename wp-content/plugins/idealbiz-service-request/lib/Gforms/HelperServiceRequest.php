...
class HelperServiceRequest
{
    ...
    function calculate_service_request_fields(&$post_data, $form, $entry)
    {
        ...
        $member_email    = get_field('expert_email',$member_id);
        $member_user_id  = get_user_by('email',$member_email)->ID;
    ...
    public function gt($toTranslate, $domain = '')
    {
        ...
        foreach ($translations as $t) {
            ...
            $langterm = str_replace(
                'polylang_mo_',
                '',
                $posts_arr[0]->post_title
            );
    ...
    public function save_service_request_data($post_id, $entry, $form)
    {
        ...
        /*  var_dump($entry) exibe todos os dados capturado no form:
            ...
            [currency] => EUR
            [post_id] => 86743
            [date_created] => 2023-03-14 17:03:06
            [date_updated] => 2023-03-14 17:03:06
            [is_starred] => 0
            [is_read] => 0
            ...
            [1.6] => Serviço
            [1.8] => 
            [2] => prestadordeservicos@idealbiz.io
            [3] => 999999999
            [9] => 3073
            [4] => teste
            [24] => 
        ...
        if (WEBSITE_SYSTEM == '1') {
            ...
            if (get_field('reference_value', $post_id)) {
                ...
                $user_compliment .= sprintf(
                    ...
                    /** %2$s -> */
                    __('_str View Request', 'idealbiz-service-request'),
                    /** %3$s -> */
                    __('_str View Request', 'idealbiz-service-request')
                );
