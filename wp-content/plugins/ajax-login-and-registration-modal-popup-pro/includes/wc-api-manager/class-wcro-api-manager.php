...
class LRM_API_Manager {
	...
	public $upgrade_url_alt = 'https://dev.maxim-kaminsky.com/mk-api/';
...
//	    var_dump($this->upgrade_url);
		...
		if ( is_admin() ) {
            ...
            if ( ! apply_filters( 'wp_doing_ajax', defined( 'DOING_AJAX' ) && DOING_AJAX ) && ! get_option($this->ame_instance_key) ) {
                $this->activation();
            }
		}
