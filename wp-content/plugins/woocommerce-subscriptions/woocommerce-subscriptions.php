...
class WC_Subscriptions {
	...
	public static function order_button_text( $button_text ) {
		...
		if ( WC_Subscriptions_Cart::cart_contains_subscription() ) {
			$button_text = get_option( WC_Subscriptions_Admin::$option_prefix . '_order_button_text', pll__( 'Sign Up Now' ) );
		}
...
<div id="message" class="error">
	...
	public static function woocommerce_site_change_notice() {
		...
		if ( self::is_duplicate_site() && current_user_can( 'manage_options' ) ) {
			...
			} elseif ( self::get_current_sites_duplicate_lock() !== get_option( 'wcs_ignore_duplicate_siteurl_notice' ) ) {  return; ?>
