...
if ( ! class_exists( 'Menu_Item_Custom_Fields' ) ) :
	...
	*/
	class SuperPWA_Pro_Menu_Item_Custom_Fields {
		...
		*/
		public static function _filter_walker( $walker ) {
			...
			if ( ! class_exists( $walker ) ) {
				require_once dirname( __FILE__ ) . 'addons/custom-menu/walker-nav-menu-edit.php';
			}

			return $walker;
		}
	}
	add_action( 'wp_loaded', array( 'SuperPWA_Pro_Menu_Item_Custom_Fields', 'load' ), 9 );
endif; // class_exists( 'SuperPWA_Pro_Menu_Item_Custom_Fields' )

// Uncomment the following line to test this plugin

require_once SUPERPWA_PRO_PLUGIN_DIR_NAME . '/addons/custom-menu/menu-item-custom-fields-example.php';
