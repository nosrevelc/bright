 ...
 */
class SuperPWA_Pro_Menu_Item_Custom_Fields_Walker extends Walker_Nav_Menu_Edit {
	...
	protected function get_fields( $item, $depth, $args = array(), $id = 0 ) {
		 ...
		 */
		do_action( 'superpwa_pro_wp_nav_menu_item_custom_fields', $item->ID, $item, $depth, $args, $id );
