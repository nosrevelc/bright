<template>
	...
	<div role="button" :id="id" class="beehive-range-picker" aria-hidden="true" ref="selector">
		<i class="sui-icon-calendar sui-md" aria-hidden="true"></i>
		<span class="beehive-range-picker-value">{{ label }}</span>
		<i class="sui-icon-chevron-down sui-sm beehive-range-picker-button" aria-hidden="true"></i>
	</div>
</template>
