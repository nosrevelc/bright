		...
		>
			<div class="sui-box">
				<div class="sui-box-header sui-flatten sui-content-center sui-spacing-top--60">
					...
					<h3 :id="`${modal}-title`" class="sui-box-title sui-lg">{{ $i18n.settings.titles.add_user }}</h3>

					<p :id="`${modal}-desc`" class="sui-description">{{ $i18n.settings.descriptions.add_user }}</p>
				</div>
				...
				<div class="sui-box-body">
					<div class="sui-form-field">
						<label
							...
							class="sui-label"
						>{{ $i18n.settings.labels.search_users }}</label>
						<sui-remote-search
							v-model="selected"
							:id="`${modal}-search`"
							:label-id="`${modal}-search-label`"
							:placeholder="$i18n.settings.labels.type_user_name"
							:ajax="ajaxObject"
						/>
					</div>
				</div>
				...
				<div class="sui-box-footer sui-flatten sui-content-separated">
					<button class="sui-button sui-button-ghost" @click="closeModal">{{ $i18n.dialogs.cancel }}</button>
