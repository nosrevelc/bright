<template>
	<div class="sui-accordion" id="beehive-settings-permissions-roles">
		<div v-if="isNetwork()" class="sui-accordion-item sui-accordion-item--disabled">
			<div class="sui-accordion-item-header">
				<div class="sui-accordion-item-title">
					...
					>
						...
						<span class="sui-screen-reader-text">{{ $i18n.settings.labels.network_administrator }}</span>
					</label>
					<span>{{ $i18n.settings.labels.network_administrator }}</span>
				</div>
				<div class="sui-accordion-col-auto" :style="{ 'pointer-events' : 'all' }">
					<span
						class="sui-tooltip sui-tooltip-constrained"
						:data-tooltip="$i18n.settings.tooltips.network_administrator"
					>
						<i class="sui-icon-info" aria-hidden="true"></i>
					</span>
					<button
						class="sui-button-icon sui-accordion-open-indicator"
						:aria-label="$i18n.accordions.open"
					>
			...
			<div class="sui-accordion-item-header">
				<div class="sui-accordion-item-title">
					<label
						...
						class="sui-toggle sui-accordion-item-action"
					>
						<input type="checkbox" id="beehive-settings-permissions-roles-administrator" checked disabled />
						<span aria-hidden="true" class="sui-toggle-slider"></span>
						<span class="sui-screen-reader-text">{{ $i18n.settings.labels.administrator }}</span>
					</label>
					<span>{{ $i18n.settings.labels.administrator }}</span>
				</div>
				<div class="sui-accordion-col-auto" :style="{ 'pointer-events' : 'all' }">
					<span
						class="sui-tooltip sui-tooltip-constrained"
						:data-tooltip="$i18n.settings.tooltips.administrator"
					>
						<i class="sui-icon-info" aria-hidden="true"></i>
					</span>
					<button
			...
			<div class="sui-accordion-item-body">
				<div class="sui-box">
					<div class="sui-box-body">
						<div class="sui-form-field" v-for="(report, type) in getReportItems" :key="type">
							<report-tree
								:role="role"
								:type="report.name"
								:title="report.title"
