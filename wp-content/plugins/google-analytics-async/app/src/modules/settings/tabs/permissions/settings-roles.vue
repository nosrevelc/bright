<template>
	<div class="sui-form-field">
		...
		>
			...
			>{{ $i18n.settings.labels.network_administrator }}</span>
		</label>
		<label
		...
		>
			...
			>{{ $i18n.settings.labels.administrator }}</span>
		</label>
		...
		>
			...
			/>
			<span aria-hidden="true"></span>
			<span :id="`beehive-settings-permissions-user-role-${role}-label`">{{ title }}</span>
		</label>
	</div>
</template>
