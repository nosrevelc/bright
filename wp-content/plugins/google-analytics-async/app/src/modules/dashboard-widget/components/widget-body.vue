	...
	<div id="beehive-widget-body" class="sui-tabs sui-tabs-overflow">
		...
		<div role="tablist" class="sui-tabs-menu">
			<button
				...
				aria-selected="true"
			>{{ $i18n.dashboard_widget.labels.general_stats }}</button>
			...
			<button
				...
				aria-selected="false"
				tabindex="-1"
			>{{ $i18n.dashboard_widget.labels.audience }}</button>
			...
			<button
				...
				aria-selected="false"
				tabindex="-1"
			>{{ $i18n.dashboard_widget.labels.top_pages }}</button>
			...
			<button
				...
				aria-selected="false"
				tabindex="-1"
			>{{ $i18n.dashboard_widget.labels.traffic }}</button>
		</div>

		<div class="sui-tabs-content">
			<general-stats v-if="canView('general')" :stats="stats" @tabChange="tabChange" />

			<audience v-if="canView('audience')" :stats="stats" :selected-item="audienceDefault" />
