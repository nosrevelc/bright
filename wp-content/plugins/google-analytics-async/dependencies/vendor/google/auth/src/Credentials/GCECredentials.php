 ...
 */
namespace Beehive\Google\Auth\Credentials;
...
use Beehive\Google\Auth\Iam;
use Beehive\Google\Auth\ProjectIdProviderInterface;
use Beehive\Google\Auth\SignBlobInterface;
use Beehive\GuzzleHttp\Exception\ClientException;
use Beehive\GuzzleHttp\Exception\ConnectException;
use Beehive\GuzzleHttp\Exception\RequestException;
use Beehive\GuzzleHttp\Exception\ServerException;
...
class GCECredentials extends \Beehive\Google\Auth\CredentialsLoader implements \Beehive\Google\Auth\SignBlobInterface, \Beehive\Google\Auth\ProjectIdProviderInterface, \Beehive\Google\Auth\GetQuotaProjectInterface
{
     ...
     */
    public function __construct(\Beehive\Google\Auth\Iam $iam = null, $scope = null, $targetAudience = null, $quotaProject = null)
    {
        $this->iam = $iam;
