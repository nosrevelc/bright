...
use DomainException;
use Beehive\Google\Auth\Credentials\AppIdentityCredentials;
use Beehive\Google\Auth\Credentials\GCECredentials;
...
class ApplicationDefaultCredentials
{
     ...
     * @throws DomainException if no implementation can be obtained.
     */
    public static function getMiddleware($scope = null, callable $httpHandler = null, array $cacheConfig = null, \Beehive\Psr\Cache\CacheItemPoolInterface $cache = null)
    {
        $creds = self::getCredentials($scope, $httpHandler, $cacheConfig, $cache);
    ...
    public static function getCredentials($scope = null, callable $httpHandler = null, array $cacheConfig = null, \Beehive\Psr\Cache\CacheItemPoolInterface $cache = null, $quotaProject = null)
    {
        ...
        } elseif (\Beehive\Google\Auth\Credentials\GCECredentials::onGce($httpHandler)) {
