<?php
/**
 * The framework image size fields file.
 *
		...
		public function render() {
			...
			if ( ! empty( $sizes ) ) {
				...
				if ( ! empty( $sizes ) ) {
					...
					echo ( esc_attr( ! empty( $this->field['empty_message'] ) ) ) ? esc_attr( $this->field['empty_message'] ) : esc_html__( 'No image sizes found.', 'post-carousel' );
