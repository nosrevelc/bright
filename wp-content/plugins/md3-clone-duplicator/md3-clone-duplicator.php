<?php
/**
 * Plugin Name:         MD3 Clone Duplicator
...
add_action( 'admin_print_scripts-sites_page_md3-clone-duplicator', 'md3_clone_scripts' );
function md3_clone_scripts() {
    wp_register_script('md3_scripts', plugins_url('js/md3_scripts.js', __FILE__));
    wp_enqueue_script('md3_scripts');
}
