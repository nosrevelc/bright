...
if( !class_exists( 'MUCD_Option' ) ) {
    ...
    class MUCD_Option {
        ...
        public static function init_options() {
            ...
            add_site_option('mucd_log_dir', $upload_dir['basedir'] . '/md3-clone-duplicator-logs/');
        ...
        public static function get_option_log_directory() {
            $upload_dir = wp_upload_dir();   
            return get_site_option('mucd_log_dir', $upload_dir['basedir'] . '/md3-clone-duplicator-logs/');
        }
