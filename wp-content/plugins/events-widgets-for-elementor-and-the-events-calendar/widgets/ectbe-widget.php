...
class ECTBE_Widget extends \Elementor\Widget_Base {
	public function __construct( $data = array(), $args = null ) {
		parent::__construct( $data, $args );
			...
			wp_register_script( 'ectbe-calendar-locales', ECTBE_URL . 'lib/js/calendar-locales-all.min.js', array( 'elementor-frontend' ), null, true );
			wp_register_script( 'ectbe-calendar-js', ECTBE_URL . 'assets/js/calendar.js', array( 'elementor-frontend', 'wp-api-request' ), null, true );
			wp_register_script( 'ectbe-calendar-main', ECTBE_URL . 'lib/js/calendar-main.min.js', array( 'elementor-frontend' ), null, true );
			wp_register_script( 'ectbe-moment-js', ECTBE_URL . 'lib/js/moment.min.js', array( 'elementor-frontend' ), null, true );
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Please share your valuable feedback', 'ectbe' ),
		...
		$this->add_control(
			...
			array(
				...
				'raw'             => '<div class="ectbe-review-list" style="
						letter-spacing: 0px;
						line-height: 20px;
						background: #dddd;
						padding: 15px;
					">Thanks for using <b>The Events Calendar Widgets For Elementor</b> WordPress plugin.<br> We hope it meets your expectations!<br>
							Please give us a quick rating, it works as a boost for us <br>
							<strong><a class="button button-primary" href="' . esc_url( 'https://wordpress.org/support/plugin/events-widgets-for-elementor-and-the-events-calendar/reviews/#new-post' ) . '" target="_blank">Share Review ⭐⭐⭐⭐⭐</a></strong><br/>	
							</div>',
		...
		$this->add_control(
			...
			array(
				...
				<a href="' . esc_url( 'https://eventscalendaraddons.com/demos/events-widgets-pro/?utm_source=ectbe_plugin&utm_medium=plugin&utm_campaign=plugin_inside&utm_content=buy-pro' ) . '" target="_blank">' . esc_html__( 'Buy Pro', 'ectbe' ) . '</a> ||	<a href="' . esc_url( 'https://eventscalendaraddons.com/demos/events-widgets-pro/?utm_source=ectbe_plugin&utm_medium=plugin&utm_campaign=plugin_inside&utm_content=free-demo' ) . '" target="_blank">' . esc_html__( 'View Demo', 'ectbe' ) . '</a>
							</div>',
