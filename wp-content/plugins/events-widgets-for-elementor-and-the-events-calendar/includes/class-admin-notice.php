...
if (!class_exists('ectbe_admin_notices')):
    ...
    final class ectbe_admin_notices
    {
        ...
        public function ectbe_add_message($notice)
        {
            ...
            add_action( 'admin_print_scripts', array($this, 'ectbe_load_script' ) );
    	 ...
    	 * @return void
    	 */
    	public function ectbe_load_script() {    	
            wp_register_style( 'ectbe-review-css', ECTBE_URL . 'assets/css/ectbe-admin-notice.css', null, null, 'all' );
            ...
            if (count($this->messages) > 0) {
                ...
                foreach ($this->messages as $id => $message) {
                    if( true == (bool) $message['review'] ){
                        ...
                        $this->ectbe_simple_notice($id, $message );
                    }
                }
            }
        }
         ...
         */
        private function ectbe_simple_notice($id, $message ){
            ...
            jQuery(document).ready(function ($) {
                ...
                $(document).on("click",".'.$id.'_admin_notice button.notice-dismiss", function (event) {
                    ...
                    $.post(ajaxURL, { "action":"ectbe_admin_notice","id":id,"_nonce":wp_nonce }, function( data ) {
