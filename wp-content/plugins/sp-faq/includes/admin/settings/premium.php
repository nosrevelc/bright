	...
	<div id="poststuff">
		<div id="post-body" class="metabox-holder">
			<div id="post-body-content">
				<h3 style="text-align:center"><?php _e( 'Compare "WP FAQ" Free VS Pro', 'sp-news-and-widget' ); ?></h3>
				    ...
				    <thead>
				    	<tr>
				    		...
				    		<th>
				    			...
				    			<a href="<?php echo SP_FAQ_PLUGIN_LINK_UPGRADE; ?>" target="_blank">Buy Now</a>
				    		</th>
				    	</tr>
				    </thead>
