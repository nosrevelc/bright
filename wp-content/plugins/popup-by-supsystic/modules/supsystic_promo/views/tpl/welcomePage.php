		...
		<div id="containerWrapper">
			...
			<div class="row">
				<div class="col-sm-8">
					<div class="row">
						<div class="col-sm-6">
							<h3><?php _e('Step-by-step tutorial', PPS_LANG_CODE)?></h3>
							<p>
								<?php _e("There're really many options of popup customization. So as soon as you close that page, I'll show you step-by-step tutorial of how to use plugin. Hope it will be usefull for you :)", PPS_LANG_CODE)?>
							</p>
							<p>
								<?php _e('As an option we can install and setup plugin for you.', PPS_LANG_CODE)?>
							</p>
						</div>
						<div class="col-sm-6">
							<h3><?php _e('Support', PPS_LANG_CODE)?></h3>
							<p>
								<?php printf(__("We love our plugin and do the best to improve all features for You. But sometimes issues happened, or you can't find required feature that you need. Don't worry, just <a href='%s' target='_blank'>contact us</a> and we will help you!", PPS_LANG_CODE), $this->getModule()->getContactLink())?>
							</p>
						</div>
					</div>
					<div class="row">
