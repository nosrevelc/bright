...
<section class="ppsPopupMainOptSect">
	...
	<label class="ppsPopupMainOptLbl" data-name="On Link Follow">
		...
		?>
		<span class="supsystic-tooltip-right" title="<?php echo esc_html(sprintf(__('Show when user opens your site exactly with link, where in the end will be #ppsShowPopUp_%d.(will work only with PRO version).', PPS_LANG_CODE), $this->popup['id']))?>">
