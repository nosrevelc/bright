 ...
 * Author URI: https://aspengrovestudios.com/?utm_source=donations-for-woocommerce&utm_medium=link&utm_campaign=wp-plugin-author-uri
 ...
 * This file was modified by Jonathan Hall, and Anna Kurowska. Last modified 2021-03-18.
*/
...
function hm_wcdon_product_data_tabs($tabs) {
	foreach ($tabs as $tabId => $tabData) {
		if ($tabId != 'general' && $tabId != 'advanced' && $tabId != 'attribute') {
