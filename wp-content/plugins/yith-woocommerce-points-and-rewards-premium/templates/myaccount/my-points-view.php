...
<div class="ywpar-wrapper">
	...
	<p>
		<?php
		$points  = sprintf( _nx( '<strong>%1$s</strong> %2$s', '<strong>%3$s</strong> %4$s', floor($points), 'First placeholder: number of points; second placeholder: label of points;','yith-woocommerce-points-and-rewards' ),  floor($points), $singular,  floor($points), $plural );
