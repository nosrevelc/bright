...
class Pektsekye_ProductOptions_Setup_Install {
	...
	public static function install(){
		...
		if ( !class_exists( 'WooCommerce' ) ) { 
		  ...
		  wp_die( __('Fixed Range Calendar requires WooCommerce to run. Please install WooCommerce and activate.', 'product-options-for-woocommerce'));
	  }
	...
	private static function get_schema(){
		...
		return " 
CREATE TABLE {$wpdb->prefix}pofw_product_option (
...
CREATE TABLE {$wpdb->prefix}pofw_product_option_value (
