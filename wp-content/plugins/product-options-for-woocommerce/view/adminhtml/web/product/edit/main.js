  ...
  $.widget("pektsekye.pofwProductOptions", { 
    ...
    _create : function () {
      ...
      this._on({                      
        ...
        "click button.pofw-show-options-button": $.proxy(this.showOps, this),
    ...
    showOps : function(e, optionId){
      $('.listing-no-visible').each(function() {
        $(this).toggleClass('listing-visible');
      }); 
    },
