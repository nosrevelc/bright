...
class Pektsekye_ProductOptions_Block_Adminhtml_Product_Edit_Tab_CustomOptions {
    ...
    if(get_post_meta($p_id, '_product_type_meta_key', true)=='listing_plan' || get_post_meta($p_id, '_product_type_meta_key', true)=='upgrade_plan'){
  ...
  public function add_product_tab($tabs){
    $tabs['product_options_for_woocommerce'] = array(
        'label' => __('Listing Options', 'product-options-for-woocommerce'),
