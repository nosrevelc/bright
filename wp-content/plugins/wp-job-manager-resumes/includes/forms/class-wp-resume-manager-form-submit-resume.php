		...
		$this->fields = apply_filters( 'submit_resume_form_fields', array(
			'resume_fields' => array(
				'candidate_name' => array(
					'label'       => __( 'Your name', 'wp-job-manager-resumes' ).'<span class="required-field">*</span>',
					'type'        => 'text',
					'required'    => true,
				...
				'candidate_email' => array(
					'label'       => __( 'Your email', 'wp-job-manager-resumes' ).'<span class="required-field">*</span>',
					'type'        => 'text',
					'required'    => true,
				...
				'candidate_title' => array(
					'label'       => __( 'Professional title', 'wp-job-manager-resumes' ).'<span class="required-field">*</span>',
					'type'        => 'text',
					'required'    => true,
				...
				'candidate_location' => array(
					'label'       => __( 'Location', 'wp-job-manager-resumes' ).'<span class="required-field">*</span>',
					'type'        => 'text',
					'required'    => true,
				...
				'resume_content' => array(
					'label'       => __( 'Resume Content', 'wp-job-manager-resumes' ).'<span class="required-field">*</span>',
					'type'        => 'wp-editor',
					'required'    => true,
					'placeholder' => '',
					'priority'    => 8
