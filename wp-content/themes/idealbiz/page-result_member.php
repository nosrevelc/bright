<?php
// Template Name: Result Search Member

/**
 * Criada pelo Cleverson
 * Esta página tem a finalidade de exibir os resultados
 * da busca de membros no sistema e não pode hover outra página
...
if($member_category){
    ...
    <section class="experts-page position-relative container medium-width">
        <div class="container text-center m-t-30">
            ...
            echo '<h1>' . get_the_title($pageidxx) . '</h1>';
        }
                ...
                <div class="row experts-container">
                    ...
                    if ($experts->have_posts()) :
                        ...
                        while ($experts->have_posts()) : $experts->the_post();
                            get_template_part('/elements/experts');
                        endwhile;
                    else :
