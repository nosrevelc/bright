<?php // Template Name: App Sub Homepage v2

/**
 * Pagina de Home page para App
 * @author Cleverson Vieira <cleverson.vieira@gmail.com>
 */

if(!wp_is_mobile()){
    $cl_home_url = home_url();
    wp_redirect($cl_home_url);
}
get_header();
