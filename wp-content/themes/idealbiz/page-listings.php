...
/* var_dump($cl_checaGET.' - '.$cl_checaSESS); */
...
$cl_pedir_login_mostrar_listing = get_field('need_login_to_view_listing');
session_start();
$_SESSION["login_listing"] = $cl_pedir_login_mostrar_listing;
    ...
    if ($cl_listing_cat = get_field('listing_category')){
        ...
        if($cl_checaGET === $cl_checaSESS){
            ...
            $args = array(
                ...
                'meta_query' => array(
                    array(
                        'key' => 'rb_post_in_recomemded_business',
                        'value' => true,
