...
<?php  if($title_cookies_1){ ?>       
    ...
    <div class="row_left hidden-mobile m-t-30">
    ...
    <div class="row_left text-left hidden-mobile m-t-30">
    <?php echo '<a class="btn-blue m-t-0" href="'.$cookies_of_page_1->guid.'" title="'.__('Listings','idealbiz').'">'.__('View All Listings','idealbiz').'</a>'; ?>
    </div>
    <div class="row_center text-center hidden-desktop" >
    <?php echo '<a class="btn-blue m-t-0" href="'.$cookies_of_page_1->ID->guid.'" title="'.__('Listings','idealbiz').'">'.__('View All Listings','idealbiz').'</a>'; ?>
    </div>
    ...
    <div class="row col-md-12 countrie <?php echo $hiddem_mobile;?> ">
        <div class="swiper-container cl_slider_cookies">
            <div class="swiper-wrapper">
                            ...
                            if ($option['external_link'] == '' && $option['button_link'] == '') { } else {
                                ?>
                                <div class="swiper-slide cl_destaque">
                                    <div class="<?php echo $b_opts;?>">
                                        <div class="b-opts-inner">
                                            <a href="<?php echo ($option['external_link'] ? $option['external_link'] : $option['button_link']); ?>" data-sbo="<?php echo $bo; ?>" style=" background-color: <?php echo $color_box; ?>; background-image:url( <?php echo $img_box; ?>);background-origin:content-box;background-position: center;background-repeat: no-repeat;background-size: 100% 60%;opacity: <?php echo $transparence; ?> ; border: 1px solid rgba(219, 219, 219, 0.2)" class="d-block <?php echo $size;?> block p-t-5 m-x-5 b-r-5 m-appicon <?php if ($option['required_login']) echo 'lrm-login'; ?>">
                                                <?php if ($option['image'] != '') { ?>
                                                    <img src="<?php echo $img_ico; ?>" class="bo-svg" alt="<?php echo $option['title_desktop']; ?>" title="<?php echo $option['title_desktop']; ?>" />
                                                <?php } else { ?>
                                                    <i class="white--color m-l-35 <?php echo $option['icon']; ?>"></i>
                                                <?php } ?>
                                                <span style = " <?php echo $font_size;?> color:<?php echo $color_text_cookie; ?>!important;" class="m-l-35 white--color <?php echo $d_none;?> d-md-block first-line center-inblock"><?php echo  $option['title_desktop']; ?></span>
                                                <div class="cl_texto_cookies" style = " <?php echo $font_size;?> color:<?php echo $color_text_cookie; ?>!important;" class="m-l-35 white--color <?php echo $d_none;?> d-md-block first-line center-inblock"><?php echo $option['text']; ?></div>
                                            </a>
...
$d_none = '';
$b_opts = '';
$size = 'w-278px h-200px';
$font_size = 'font-size:1.38em !important;';
?>
    <div class="container">
<?php if($title_cookies_1){ ?>       
        ...
        <div class="swiper-wrapper">
                        ...
                        if ($option['external_link'] == '' && $option['button_link'] == '') { } else {
                            ...
                            <div class="swiper-slide">
                                <div class="<?php echo $b_opts;?>">
                                    <div class="b-opts-inner">
                                        <a href="<?php echo ($option['external_link'] ? $option['external_link'] : $option['button_link']); ?>" data-sbo="<?php echo $bo; ?>" style=" background-color: <?php echo $color_box; ?>; background-image:url( <?php echo $img_box; ?>); background-size: 100% 100%;opacity: <?php echo $transparence; ?> ; border: 1px solid rgba(219, 219, 219, 0.2)" id="Cookie_2" class="d-block <?php echo $size;?> block p-t-5 m-x-5 b-r-5 m-appicon <?php if ($option['required_login']) echo 'lrm-login'; ?>">
                                            <?php if ($option['image'] != '') { ?>
                                                <img src="<?php echo $img_ico; ?>" class="bo-svg" alt="<?php echo $option['title_desktop']; ?>" title="<?php echo $option['title_desktop']; ?>" />
                                            <?php } else { ?>
                                                <i class="white--color m-l-35 <?php echo $option['icon']; ?>"></i>
