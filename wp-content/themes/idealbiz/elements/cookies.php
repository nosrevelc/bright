...
<?php }?>
<?php  
/* var_dump(get_field('business_options'.$conj_cookies.'',$cookies_of_page_1->ID)); */
...
<div class="site-blocks d-flex flex-row flex-wrap justify-content-center container <?php echo $hiddem_desktop;?>">  
    ...
    <?php
    $business_options = get_field('business_options'.$conj_cookies.'',$cookies_of_page_1->ID);
                            ...
                            if ($option['external_link'] == '' && $option['button_link'] == '') { } else {
                                ?>
                                    <div class="b-opts">
                                        ...
                                        <span style = "font-weight:600;color:<?php echo $color_text_mobile; ?>!important;" class="d-block d-md-none"><?php echo $option['title']; ?></span>
                                    </div>
                            <?php }?>
                            <?php
                                }
...
<?php /* var_dump(get_field('business_options'.$conj_cookies.'',$cookies_of_page_1->ID)); */?>

<div class="row col-md-12 countrie v-size <?php echo $hiddem_mobile;?>">
    ...
    <div class="swiper-wrapper">
                    ...
                    /* if ($option['icon_color'] != '') { */
                       ...
                       //DESTAQUE AQUI ABAIXO.
                        /* var_dump($option['detach']); */
                    /* } */
                    
                    if ($option['detach'] == $destaque){
                    if ($option['external_link'] == '' && $option['button_link'] == '') { } else {
                        ?>
                        <div class="swiper-slide cl_cookies">
                            <div class="<?php echo $b_opts;?> card_cookies">
                                <div class="b-opts-inner sub_card_cookies">
                                    <a href="<?php echo ($option['external_link'] ? $option['external_link'] : $option['button_link']); ?>" data-sbo="<?php echo $bo; ?>" style=" background-color: <?php echo $color_box; ?>; background-image:url( <?php echo $img_box; ?>); background-size: 100% 100%;opacity: <?php echo $transparence; ?> ; border: 1px solid rgba(219, 219, 219, 0.2)" class="d-block <?php echo $size;?> block p-t-5 m-x-5 b-r-5 m-appicon <?php if ($option['required_login']) echo 'lrm-login'; ?>">
                                        ...
                                        <?php } else { ?>
                                            <i class="white--color m-l-35 <?php echo $option['icon']; ?>"></i>
                                        <?php } ?>
                                        <h2 style = " <?php echo $font_size;?> color:<?php echo $color_text_cookie; ?>!important;" class="font_bold m-l-35 white--color <?php echo $d_none;?> d-md-block first-line center-inblock"><?php echo str_replace_first(' ', '<br/>', $option['title_desktop']); ?></h2>
                                    </a>
