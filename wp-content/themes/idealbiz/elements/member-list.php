...
$cl_show_this_member_in_list = get_field('show_this_member_in_list');
if ($cl_show_this_member_in_list == NULL) {
    $cl_show_this_member_in_list = "show_list";
}

if ($cl_show_this_member_in_list === "show_list") {
?>
