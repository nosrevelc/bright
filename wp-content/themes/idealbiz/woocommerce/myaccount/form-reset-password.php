...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p class ="titulo_destaque"><?php echo apply_filters( 'woocommerce_reset_password_message', esc_html__( 'Enter a new password below.', 'woocommerce' ) ); ?></p><?php // @codingStandardsIgnoreLine ?>

	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first titulo_destaque">
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last titulo_destaque">
	...
	<p class="woocommerce-form-row form-row titulo_destaque">
