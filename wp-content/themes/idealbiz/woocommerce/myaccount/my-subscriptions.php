...
<div class="woocommerce_account_subscriptions">
	...
	<h2 class="text-left m-b-15">
		<?php esc_html_e( 'My Subscriptions', 'woocommerce-subscriptions' ); ?>
	</h2>
	<?php if ( ! empty( $subscriptions ) ) : ?>
	<table class="shop_table shop_table_responsive my_account_subscriptions my_account_orders m-b-0">
	...
	<thead>
		<tr>
			...
			<th class="subscription-next-payment order-date"><span class="nobr"><?php esc_html_e( 'Next Payment', 'table heading', 'woocommerce-subscriptions' ); ?></span></th>
			<th class="subscription-total order-total"><span class="nobr"><?php esc_html_e( 'Total', 'table heading', 'woocommerce-subscriptions' ); ?></span></th>
	...
	<?php foreach ( $subscriptions as $subscription_id => $subscription ) : ?>
		<tr class="order">
			...
			<td class="subscription-actions order-actions">
				<a href="<?php echo esc_url( $subscription->get_view_order_url() ) ?>" class="btn btn-blue blue--hover  view"><?php esc_html_e( 'View', 'view a subscription', 'woocommerce-subscriptions' ); ?></a>
	...
	<?php else : ?>
		...
		<p class="no_subscriptions">
			...
			printf( esc_html__( 'You have no active subscriptions.', 'woocommerce-subscriptions' ));
			?>
		</p>
