...
<div class="block stroke dropshadow p-30 m-b-25 b-r-5 white--background"> 
	<h2 class="text-left m-b-15">
		<?php esc_html_e( 'Related Subscriptions', 'woocommerce-subscriptions' ); ?>
	</h2>
    <table class="shop_table shop_table_responsive my_account_orders m-b-0">
        <thead>
            <tr>
                ...
                <th class="order-date"><span class="nobr"><?php esc_html_e( 'Next Payment', 'table heading', 'woocommerce-subscriptions' ); ?></span></th>
                <th class="order-total"><span class="nobr"><?php esc_html_e( 'Total', 'table heading', 'woocommerce-subscriptions' ); ?></span></th>
            ...
            <?php foreach ( $subscriptions as $subscription_id => $subscription ) : ?>
                <tr class="order">
                    ...
                    <td class="subscription-actions order-actions">
                        <a href="<?php echo esc_url( $subscription->get_view_order_url() ) ?>" class="btn btn-blue blue--hover "><?php esc_html_e( 'View', 'view a subscription', 'woocommerce-subscriptions' ); ?></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
