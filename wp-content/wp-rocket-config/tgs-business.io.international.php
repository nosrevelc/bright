...
$rocket_cache_reject_uri = '/international/en/our-philosophy-and-values/|/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/international/en/checkout/(.*)|/international/en/cart/|/international/en/my-account/(.*)|/international/wc-api/v(.*)|(/[^/]+)?/(index\.php/)?wp\-json(/.*|$)|/international/login/';
...
$rocket_secret_cache_key = '63e619194a91d616287189';
$rocket_cache_ssl = 1;
