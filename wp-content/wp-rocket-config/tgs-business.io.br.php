...
$rocket_secret_cache_key = '63ecec62ac48f935699601';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 0;
$rocket_cache_webp = 0;
$rocket_cache_ssl = 1;
$rocket_cache_reject_uri = '/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/br/en/cart/|/br/pt/carrinho-compras/|/br/en/my-account/(.*)|/br/pt/minha-conta/(.*)|/br/wc-api/v(.*)|(/[^/]+)?/(index\.php/)?wp\-json(/.*|$)|/br/login/';
