...
$rocket_secret_cache_key = '63ee0e2f33d67953296374';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 0;
$rocket_cache_webp = 0;
$rocket_cache_ssl = 1;
$rocket_cache_reject_uri = '/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/my/en/checkout/(.*)|/my/en/cart/|/my/en/my-account/(.*)|/my/wc-api/v(.*)|(/[^/]+)?/(index\.php/)?wp\-json(/.*|$)|/my/login/';
