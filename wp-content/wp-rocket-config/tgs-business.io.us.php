...
$rocket_cache_reject_uri = '/international/en/our-philosophy-and-values/|/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/us/en/checkout/(.*)|/us/en/cart/|/us/en/my-account/(.*)|/us/wc-api/v(.*)|(/[^/]+)?/(index\.php/)?wp\-json(/.*|$)|/us/login/';
