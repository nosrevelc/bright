...
$rocket_cache_reject_uri = '/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/network/en/checkout/(.*)|/network/en/cart/|/network/en/my-account/(.*)|/network/wc-api/v(.*)|(/[^/]+)?/(index\.php/)?wp\-json(/.*|$)|/network/login/';
...
$rocket_secret_cache_key = '6273f38083165220329449';
$rocket_cache_ssl = 1;
