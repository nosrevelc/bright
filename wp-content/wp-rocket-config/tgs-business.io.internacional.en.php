...
$rocket_cache_reject_uri = '/internacional/en(/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/checkout/(.*)|/pt/finalizar-compra/(.*)|/cart/|/pt/carrinho/|/my-account/(.*)|/pt/minha-conta/(.*)|/wc-api/v(.*)|(/[^/]+)?/(index\.php/)?wp\-json(/.*|$)|/login/)';
