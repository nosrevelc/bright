...
$rocket_cache_reject_uri = '/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/pt/pt/checkout-2/(.*)|/pt/en/(.*)|/pt/pt/carrinho-compras/|/pt/pt/minha-conta/(.*)|/pt/wc-api/v(.*)|(/[^/]+)?/(index\.php/)?wp\-json(/.*|$)|/pt/login/';
...
$rocket_secret_cache_key = '63e5311ac9e07735920175';
$rocket_cache_ssl = 1;
