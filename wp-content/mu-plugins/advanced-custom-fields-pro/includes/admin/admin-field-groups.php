...
<div class="acf-column-2">
	<div class="acf-box">
		<div class="inner">
			<h2>Update All Sites Custom Fields</h2>
			<p style="text-align:center;"> <a href="edit.php?post_type=acf-field-group&page=acf-tools&updatefields=allsites"> Update </a></p>
		</div>
		<div class="footer">
