...
*/
	...
	*/
	...
	function html_generate() {
		...
		$sn='';
		$sn = $sn . "<?php if( function_exists('acf_add_local_field_group') ): ";
		...
		foreach( $json as $field_group ) {
			...
			$sn = $sn . "acf_add_local_field_group({$code});";
		
		}
		$sn = $sn . "endif;";
		echo "endif;";

		$fp = fopen(WPMU_PLUGIN_DIR . '/advanced-custom-fields-pro/acf-json/'.'acf.php', 'w');
		//var_dump(WPMU_PLUGIN_DIR . '/advanced-custom-fields-pro/acf-json/'.'acf.php');
