...
add_post_type_support( 'counseling', 'thumbnail' );  

// Register Custom Post Type - Service & Counselings
function counseling() {

	$labels = array(
		'name'                  => _x( 'Counselings', 'Post Type General Name', 'idealbiz' ),
		'singular_name'         => _x( 'Counseling', 'Post Type Singular Name', 'idealbiz' ),
		'menu_name'             => __( 'Counselings', 'idealbiz' ),
		'name_admin_bar'        => __( 'Counselings', 'idealbiz' ),
		'archives'              => __( 'Item Archives', 'idealbiz' ),
		'attributes'            => __( 'Item Attributes', 'idealbiz' ),
		'parent_item_colon'     => __( 'Parent Item:', 'idealbiz' ),
		'all_items'             => __( 'Counselings', 'idealbiz' ),
		'add_new_item'          => __( 'Add New Item', 'idealbiz' ),
		'add_new'               => __( 'Add New Counseling', 'idealbiz' ),
	...
	$args = array(
		'label'                 => __( 'Counseling', 'idealbiz' ),
		'description'           => __( 'Counseling Post type', 'idealbiz' ),
		'labels'                => $labels,
