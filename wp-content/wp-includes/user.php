...
###SITEURL###'
			...
			$pass_change_text= pll__('Hi ###USERNAME###, This notice confirms that your password was changed on ###SITENAME###. If you did not change your password, please contact the Site Administrator at ###ADMIN_EMAIL### This email has been sent to ###EMAIL### Regards,  All at ###SITENAME###  ###SITEURL###','ajax-login-and-registration-modal-popup-pro');
			$hi = pll__( 'Password Registery Change','idealbiz' );
			$emailHtml  = get_email_header();
			$emailHtml .= get_email_intro('', $pass_change_text, $hi);
